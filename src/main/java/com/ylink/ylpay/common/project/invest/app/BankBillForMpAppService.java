...
import com.ylink.ylpay.common.project.invest.dto.BankBillDetailDTO;
import com.ylink.ylpay.common.project.invest.dto.BankBillTotalDTO;
import com.ylink.ylpay.common.project.invest.dto.BusinessDTO;
import com.ylink.ylpay.common.project.invest.dto.BusinessNoticeDTO;
 ...
 * @操作原因：
 */
public interface BankBillForMpAppService {
	 ...
	 */
	public ListPage<BusinessDTO> findBusinessListPage(ListPage<BusinessDTO> page, BusinessDTO dto)throws InvestCheckedException;
	/**
	 * @方法描述:  分页查询日志信息
	 * @作者： hinode
	 ...
	 */
	public ListPage<BusinessNoticeDTO> findListPagte(ListPage<BusinessNoticeDTO> page, BusinessNoticeDTO dto)throws InvestCheckedException;
}
