/**
 * GuaranteeAccountPaymentMainDTO.java
 ...
 * @author LiuQ
 * @date 2013-3-28
 * @description：担保支付--账户支付主DTO
 */
public class GuaranteeAccountPaymentMainDTO extends BaseDTO{
	 ...
	 * 订单明细
	 */
	private List<GuaranteeAccountPaymentDTO> mergerDetails;
	/**
	 * @return the optCode
	 */
	 ...
	 */
	public List<GuaranteeAccountPaymentDTO> getMergerDetails() {
		return mergerDetails;
	}
	/**
	 * @param mergerDetails the mergerDetails to set
	 */
	public void setMergerDetails(List<GuaranteeAccountPaymentDTO> mergerDetails) {
