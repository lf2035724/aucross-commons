/**
 * RedemptionAccountTransferDTO.java
...
/**
 * @author LiuQ 实时赎回资金调拨DTO
 * @date 2013-11-13
 * @description 
 */
public class RedemptionAccountTransferDTO extends PaymentInfoDTO {

	private static final long serialVersionUID = 1586763551930739525L;
