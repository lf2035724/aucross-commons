 ...
 * @date 2012-12-20
 * @description：应付款转账DTO
 */

public class PayablesTransferDTO extends PaymentInfoDTO {
    ...
    */
	...
	public String getPayablesCustId() {
		return payablesCustId;
	}
	public void setPayablesCustId(String payablesCustId) {
		this.payablesCustId = payablesCustId;
	}
