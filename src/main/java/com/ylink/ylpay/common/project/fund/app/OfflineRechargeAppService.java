...
public interface OfflineRechargeAppService {
	...
	public OfflineRechargeOrderDTO findFirstTrialOrder(String userName, String bankCardNo,
			String rechargeCode, long rechargeAmt) throws FundCheckedException;
	 ...
	 * @date 2014-3-13
	 */
	public void firstTrial(String id, String result, String message, String checker) throws FundCheckedException;
	 ...
	 * @date 2014-3-13
	 */
	public void recheck(String id, String result, String message, String checker) throws FundCheckedException;
