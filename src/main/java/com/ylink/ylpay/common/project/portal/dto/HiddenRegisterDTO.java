...
public class HiddenRegisterDTO extends AbstractDTO {
	...
	public String toString() {
		return "HiddenRegisterDTO [instuId=" + instuId + ", userType=" + userType + ", userNameText=" + userNameText + ", certType=" + certType + ", certId="
				+ certId + ", bankCode=" + bankCode + ", bankProvinceCode=" + bankProvinceCode + ", bankRegionCode=" + bankRegionCode + ", cardNo=" + cardNo
				+ ", tiedCardType=" + tiedCardType + ", orderType=" + orderType + ", counterNo=" + counterNo + ", fundDate=" + fundDate + ", fundTime="
				+ fundTime + ", fundSeqId=" + fundSeqId + ", merchantDate=" + merchantDate + ", merchantTime=" + merchantTime + ", merchantSeqId="
				+ merchantSeqId + ", pgRecvUrl=" + pgRecvUrl + ", bgRecvUrl=" + bgRecvUrl + ", resv=" + resv + ", mobile=" + mobile + ", accountPsw="
				+ accountPsw + "]";
	}
}
