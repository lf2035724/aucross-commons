/**
 * GuaranteeShortcutPaymentMainDTO.java
 ...
 * @author LiuQ
 * @date 2013-3-28
 * @description：担保支付--快捷支付主DTO
 */
public class GuaranteeShortcutPaymentMainDTO extends BaseDTO{
	 ...
	 * 订单明细
	 */
	private List<GuaranteeShortcutPaymentDTO> mergerDetails;
	/**
	 * @return the optCode
	 */
	 ...
	 */
	public List<GuaranteeShortcutPaymentDTO> getMergerDetails() {
		return mergerDetails;
	}
	/**
	 * @param mergerDetails the mergerDetails to set
	 */
	public void setMergerDetails(List<GuaranteeShortcutPaymentDTO> mergerDetails) {
