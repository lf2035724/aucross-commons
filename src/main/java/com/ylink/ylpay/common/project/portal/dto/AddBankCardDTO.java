...
public class AddBankCardDTO extends AbstractDTO {
	...
	public String toString() {
		return "AddBankCardDTO [instuId=" + instuId + ", userId=" + userId + ", userNameText=" + userNameText + ", certType=" + certType + ", certId=" + certId
				+ ", bankCode=" + bankCode + ", bankProvinceCode=" + bankProvinceCode + ", bankRegionCode=" + bankRegionCode + ", cardNo=" + cardNo
				+ ", tiedCardType=" + tiedCardType + ", orderType=" + orderType + ", fundDate=" + fundDate + ", fundTime=" + fundTime + ", fundSeqId="
				+ fundSeqId + ", merchantDate=" + merchantDate + ", merchantTime=" + merchantTime + ", merchantSeqId=" + merchantSeqId + ", pgRecvUrl="
				+ pgRecvUrl + ", bgRecvUrl=" + bgRecvUrl + ", resv=" + resv + ", mobile=" + mobile + ", accountPsw=" + accountPsw + "]";
	}
